                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('reservasi.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="date" name="date" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="keluhan" name="keluhan" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('keluhan') }}</textarea>
